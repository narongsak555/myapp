...
<body>
  ...
  <div class="container container-sale">
          ...
          <div class="modal-body">
            ...
            <form action="insert_product.php" method="post" enctype="multipart/form-data"> <!-- enctype เอาไว้ใช้ insert image -->
              <div class="mb-3">
                ...
                <input type="text" required class="form-control" name="pd_name">
              </div>
              <div class="mb-3">
    ...
    <table class="table table-sm table-hover" id="myTable"  style="margin: inherit; margin-top: 3rem;">
    ...
    ?>
      ...
      <tr>
        ...
        <td width="100px" height="100px" class="td_sale">
          <div class="card" style="width: 100%;">
            <img width="100px" height="" src="uploads/<?= $product['img']; ?>" class="rounded" alt="No Picture">
            <div class="card-body">
